import './FinishedCompetition.scss'
export const FinishedCompetition = () => {
    return (
        <div className='grid grid-cols-1  my-4 FinishedCompetition'>
            <div className="grid grid-cols-2 mb-4 animate_animated animate_fadeIn mission-content">
                ...
                <div className="col-start-2 flex justify-end">
                    <div className="flex gap-4 mission-status">
                        <div className="finished">مسابقة منتهية</div>
