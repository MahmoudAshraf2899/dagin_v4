...
import { handleSelectedCompetitonType, toggleShowAddCompetition } from '../../../redux/Slices/CompetitionsSlice';
...
export const CompetitionsHeader = () => {
    ...
    const handleActiveElement = (id: number) => {
        setActiveElement(id);
        let type = id;
        dispatch(handleSelectedCompetitonType({ type }));
    };
    const showAddCompetition = () => {
        let isVisible = true;
        dispatch(toggleShowAddCompetition({ isVisible }));
    };
    return (
        <div className="grid grid-cols-2 xs:grid-col-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 p-4 CompetitionsHeader"
            ...
            <div className="col-start-2  flex justify-end">
                <div className="flex">
                    ...
                    {/* Add Button */}
                    <div className="add-mission-btn"
                        onClick={() => showAddCompetition()}
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="21"
