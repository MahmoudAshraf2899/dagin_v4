import './TodayCompetitions.scss'
export const TodayCompetitions = () => {
    return (
        <div className='col-span-full TodayCompetitions'>
            <div className="grid grid-cols-2 mb-4 animate_animated animate_fadeIn mission-content">
                ...
                <div className="col-start-1">
                    <div className="flex gap-4">
                        <div className="mission-reward">المكافأه 100 جنيه</div>
