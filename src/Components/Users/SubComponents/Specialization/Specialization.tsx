...
import API from '../../../../Api';
import { setSelectedSpecialties } from '../../../../redux/Slices/UsersSlice';
export const Specialization = () => {
    ...
    const submitChoise = () => {
        let specialtiesId = selectedItemId;
        let specialtiesName = selectedItemName;
        dispatch(setSelectedSpecialties({ specialtiesId, specialtiesName }));
    };
