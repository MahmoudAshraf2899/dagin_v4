import './Competions.scss'
import diamond from "../../../../Assets/Icons/diamond (1).svg";
export const Competions = () => {
    return (
        <div className="Competions">
            <div className='grid grid-cols-2 mt-10 pr-10'>
                <div className='col-span-full'>
                    <h3 className='title'>المسابقات</h3>
                </div>
            </div>
            <div className='competion-container'>
                <div className='grid grid-cols-2'>
                    <div className='col-span-full'>
                        <div className='flex justify-between'>
                            <div className='grid'>
                                <div className='competition-type'>نوع المسابقة</div>
                                <div className='competion-address'>عنوان المسابقة هنا</div>
                    ...
                    <div className='col-start-1 mt-4'>
                        <div className='percentage'>تمت بنسبة 90 %</div>
                    </div>
                    <div className='col-start-1 mt-4'>
